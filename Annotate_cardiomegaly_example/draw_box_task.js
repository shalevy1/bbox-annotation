var VG = (function(vg) {
	...
	// $(document.documentElement).keyup(function(e) {
		...
		// if ($.inArray(e.keyCode, [78]) !== -1) bbox_drawer.switchButtonFun();
	// });
	...
	that.NoBoxes = function () {
		bbox_drawer.switchButtonFun();
	}
